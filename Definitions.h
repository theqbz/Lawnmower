...
#define ARROW_DOWN_FAR          char(95)
#define ARROW_LEFT              char(27)
#define ARROW_LEFT_FAR          char(60)
#define ARROW_RIGHT             char(26)
#define ARROW_RIGHT_FAR         char(62)
#define ARROW_UPLEFT            char(218)
#define ARROW_UPLEFT_FAR        char(201)
#define ARROW_UPRIGHT           char(191)
#define ARROW_UPRIGHT_FAR       char(187)
#define ARROW_DOWNLEFT          char(192)
#define ARROW_DOWNLEFT_FAR      char(200)
#define ARROW_DOWNRIGHT         char(217)
#define ARROW_DOWNRIGHT_FAR     char(188)
